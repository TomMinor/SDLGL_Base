#############################################################################
# Makefile for building: sdlgl
# Generated by qmake (3.0) (Qt 5.4.1)
# Project:  sdlgl.pro
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile sdlgl.pro
#############################################################################
...
CXXFLAGS      = -pipe -I/usr/local/include/SDL2 -D_REENTRANT -O2 -g -pipe -Wall -Wp,-D_FORTIFY_SOURCE=2 -fstack-protector-strong --param=ssp-buffer-size=4 -grecord-gcc-switches -m64 -mtune=generic -O2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
INCPATH       = -I. -Iinclude -isystem /usr/include/qt5 -isystem /usr/include/qt5/QtGui -isystem /usr/include/qt5/QtCore -I. -I/usr/lib64/qt5/mkspecs/linux-g++
...
COMPRESS      = gzip -9f
DISTNAME      = sdlgl1.0.0
DISTDIR = /home/tom/src/GLProject/SDLGL_Base/.tmp/sdlgl1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-z,relro
LIBS          = $(SUBLIBS) -L/usr/local/lib -Wl,-rpath,/usr/local/lib -lSDL2 -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = 
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		sdlgl.pro include/*.h src/main.cpp
QMAKE_TARGET  = sdlgl
...
Makefile: sdlgl.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/*.h $(DISTDIR)/
